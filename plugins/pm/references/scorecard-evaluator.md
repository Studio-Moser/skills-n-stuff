...
conditions that define "done"? Apply the canonical Testing Seam selection rule from
`references/work-readiness.md`. Vague criteria like "works well" or "is performant"
fail this check.
