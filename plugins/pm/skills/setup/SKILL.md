...
If the backend is Trello, follow the full Trello interview in `references/setup-trello.md` (Batch 1.5 section), then return here. Skip entirely for GitHub/local.
...
If the backend is Trello, follow `references/setup-trello.md` (Phase 6T section) to create lists, labels, and register the webhook. Skip for GitHub/local.
