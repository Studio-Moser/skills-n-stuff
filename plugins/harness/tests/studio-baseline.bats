...
required = (
    ...
    "choose installed skills from the task being asked",
    "invoke a matching skill even when the user did not name it",
    "for one focused repository implementation or bug fix, use `pm:dev-task` when installed",
    "polish implementation stays with the root",
    "small and feature implementation routes through harness",
